...
# upstream   https://github.com/bzumhagen/ProxmoxVED.git (fetch)
# upstream   https://github.com/bzumhagen/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/bzumhagen/ProxmoxVED"
echo ""
