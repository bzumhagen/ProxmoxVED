...
# Repo: https://github.com/bzumhagen/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/bzumhagen/ProxmoxVED/raw/test/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/bzumhagen/ProxmoxVED
...
source <(wget -qO- https://github.com/bzumhagen/ProxmoxVED/raw/test/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/bzumhagen/ProxmoxVED/raw/test/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/bzumhagen/ProxmoxVED/raw/test/tools/pve/gpu-amd.func)
