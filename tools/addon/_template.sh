...
source <(curl -fsSL https://raw.githubusercontent.com/bzumhagen/ProxmoxVED/test/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/bzumhagen/ProxmoxVED/test/misc/tools.func)
...
source <(curl -fsSL https://raw.githubusercontent.com/bzumhagen/ProxmoxVED/test/misc/tools.func) 2>/dev/null || {
